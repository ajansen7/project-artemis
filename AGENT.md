...
- **Scout skill**: `.claude/skills/scout/SKILL.md` — job scouting, pipeline management, applications
...
```
uv run python .claude/skills/scout/scripts/db.py <command>
```

Run `uv run python .claude/skills/scout/scripts/db.py --help` to see available commands.
