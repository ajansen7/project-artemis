export interface Job {
  ...
  applications?: { resume_md: string | null; cover_letter_md: string | null; primer_md: string | null; form_fills_md: string | null; resume_pdf_path: string | null; resume_pdf_path_storage: string | null; resume_docx_path: string | null; submitted_at: string | null }[];
}
