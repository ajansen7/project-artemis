...
Usage:
  ...
  uv run python .claude/skills/scout/scripts/generate_resume_docx.py --resume-path path/to/resume.md
...
TEMPLATE_PATH = Path(__file__).parent.parent / "references" / "resume_template.docx"
