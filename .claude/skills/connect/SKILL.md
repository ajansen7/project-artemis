...
# Connect — Networking Pipeline Skill
...
| Candidate context | `.claude/skills/hunt/references/candidate_context.md` | Target companies, active roles |
