...
| Candidate context | `state/candidate_context.md` | Cached candidate profile (primary context source) |
| Preferences | `state/preferences.md` | Target roles, companies, search keywords |
