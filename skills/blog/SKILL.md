...
4. Batch import to DB: `echo '<json>' | artemis-db batch-import-blog-posts`
...
7. Scan recent pipeline activity: `artemis-db list-jobs --limit 10`
...
**Steps:**
1. Look up the post in the DB: `artemis-db list-blog-posts` — find by slug
...
2. Query DB: `artemis-db list-blog-posts`
